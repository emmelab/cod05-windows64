...
public class Observador_Kinect extends PApplet {
...
class Motor{
  ...
  private void iniciarEspacio3D(){
    ...
    camaraZ = ((espacio3D.height/2.0f) / tan(PI*60.0f/360.0f));
    espacio3D.beginDraw();
  ...
  private void actualizarEspacio3D(){
    espacio3D.beginDraw();
      ...
      espacio3D.perspective( PI/3.0f, espacio3D.width/espacio3D.height, camaraZ/10.0f, camaraZ*25.0f );
      espacio3D.translate(width/2, height/2, 0);
      espacio3D.lights();
      espacio3D.rotateX(PI);
      espacio3D.translate(0, 0, -1000 );
...
public int[][] getParesDeJoints(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Observador_Kinect" };
    if (passedArgs != null) {
